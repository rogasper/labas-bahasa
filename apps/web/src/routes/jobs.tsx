        ...
        return (
          <div key={i} className="flex flex-col">
            ...
            {isExpanded && hasDetails && (
              <div className="ml-6 mt-1 mb-2 p-2.5 rounded-lg bg-black/60 border border-white/10 text-white/70 whitespace-pre-wrap text-[10px] leading-relaxed max-h-48 overflow-y-auto">
