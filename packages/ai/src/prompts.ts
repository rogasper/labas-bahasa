...
- For matching_information: options are information items (numbered statements) with key and text. correctAnswer is a serialized mapping e.g. "1:D,2:E,3:G" mapping each item key to its paragraph letter. matchTargets must list all paragraph letters used in the passage (e.g. ["A","B","C","D","E","F","G"]).
- For matching_headings: options are heading items with key and text. correctAnswer is a serialized mapping e.g. "1:C,2:A,3:F" mapping each heading key to its paragraph letter. matchTargets must list all paragraph letters used in the passage (e.g. ["A","B","C","D","E","F"]).
